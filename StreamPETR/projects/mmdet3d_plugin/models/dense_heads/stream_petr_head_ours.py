...
from projects.mmdet3d_plugin.models.dense_heads.petr_head_dn_ours import pos2posemb1d, pos2posemb4d

@HEADS.register_module()
class StreamPETROursHead(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        if class_weight is not None and (self.__class__ is StreamPETROursHead):
        ...
        super(StreamPETROursHead, self).__init__(num_classes, in_channels, init_cfg=init_cfg)
    ...
    def _init_layers(self):
        ...
        self.time_embedding = nn.Sequential(
            nn.Linear(self.pe_dims, self.embed_dims),
    ...
    def _get_query_embeds(self, ref_pts, scale=10.0):
        x = ref_pts[..., 0] - 0.5
        y = ref_pts[..., 1] - 0.5
        z = ref_pts[..., 2]
    ...
    def temporal_alignment(self, query_pos, tgt, reference_points):
        ...
        temp_pos = self._get_query_embeds(temp_reference_point)
        ...
        query_pos += self.time_embedding(pos2posemb1d(torch.zeros_like(reference_points[..., :1]), self.pe_dims))
        temp_pos += self.time_embedding(pos2posemb1d(self.memory_timestamp, self.pe_dims).float())
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        if (version is None or version < 2) and self.__class__ is StreamPETROursHead:
            convert_dict = {
