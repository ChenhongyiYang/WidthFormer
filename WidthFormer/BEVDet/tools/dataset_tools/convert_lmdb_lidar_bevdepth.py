...
class LmdbDataExporter(object):
    ...
    def _extract_once(self, item) -> Tuple[bytes, bytes]:
        ...
        try:
            ...
            points = np.fromfile(full_path, dtype=np.float32, count=-1) # .reshape(-1, 5)[..., :4]
        except:
...
if __name__ == '__main__':
    ...
    output_path = '/scratch_fast/datasets/nuScenes/lmdb/lidar_bevdepth'
    #
    # img_lists = [
    ...
    exporter_train = LmdbDataExporter(img_lists, output_path, batch_size=5000)
