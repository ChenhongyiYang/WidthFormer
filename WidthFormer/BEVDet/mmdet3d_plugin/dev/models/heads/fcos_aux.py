...
class FCOSAuxFlattenHeadDev(BaseMono3DDenseHead):
    ...
    def __init__(
        ...
        super(FCOSAuxFlattenHeadDev, self).__init__(init_cfg=init_cfg)
        ...
        reg_out_channels = (1, depth_bins+2, input_size[0]//down_stride, 3)
        self.reg_out_channels = list(reg_out_channels)
        assert len(reg_out_channels) == 4
    ...
    def _split_bbox_preds(self, bbox_preds):
        ...
        return delta_preds, depth_preds, height_preds, bbox3d_preds
    ...
    def loss(self,
        ...
        bbox3d_targets = bbox_targets_3d[: ,3:]
        ...
        delta_preds, depth_preds, height_preds, bbox3d_preds = self._split_bbox_preds(bbox_preds)
    ...
    def _get_target_cam(self,
        ...
        bbox_targets_3d = torch.cat([delta_xs, gt_depth, gt_height_center, gt_bbox], dim=-1)
