_base_ = ['../template/bevdet4d_bs8.py']
...
embed_dims=64
model = dict(
    type='BEVDetSequentialES_WidthSup',
    ...
    img_bev_encoder_backbone=dict(numC_input=2*embed_dims, with_cp=False),
    img_bev_encoder_neck=dict(in_channels=embed_dims*8+embed_dims*2),
    pre_process=dict(numC_input=embed_dims),
    head_2d_cfg=dict(
