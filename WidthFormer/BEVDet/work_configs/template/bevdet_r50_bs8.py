...
model = dict(
    ...
    img_bev_encoder_backbone = dict(type='ResNetForBEVDet_CorrectCP', numC_input=numC_Trans, with_cp=True),
    img_bev_encoder_neck = dict(type='FPN_LSS_BEVDet',
...
lr_config = dict(
    ...
    warmup_ratio=0.001,
    step=[16, 22])
runner = dict(type='AmpEpochBasedRunner', max_epochs=24)
